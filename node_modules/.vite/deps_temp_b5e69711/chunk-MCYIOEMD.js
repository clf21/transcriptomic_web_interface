...
${indentData}`);
    ...
    function installMathOperations(AbstractMatrix4, Matrix4) {
      AbstractMatrix4.prototype.add = function add(value) {
        if (typeof value === "number") return this.addS(value);
        return this.addM(value);
      };
      AbstractMatrix4.prototype.addS = function addS(value) {
      ...
      AbstractMatrix4.prototype.addM = function addM(matrix2) {
      ...
      AbstractMatrix4.add = function add(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.add(value);
      };
      AbstractMatrix4.prototype.sub = function sub(value) {
        if (typeof value === "number") return this.subS(value);
        return this.subM(value);
      };
      AbstractMatrix4.prototype.subS = function subS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) - value);
          }
      ...
      AbstractMatrix4.prototype.subM = function subM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.sub = function sub(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.sub(value);
      };
      AbstractMatrix4.prototype.subtract = AbstractMatrix4.prototype.sub;
      AbstractMatrix4.prototype.subtractS = AbstractMatrix4.prototype.subS;
      AbstractMatrix4.prototype.subtractM = AbstractMatrix4.prototype.subM;
      AbstractMatrix4.subtract = AbstractMatrix4.sub;
      AbstractMatrix4.prototype.mul = function mul(value) {
        if (typeof value === "number") return this.mulS(value);
        return this.mulM(value);
      };
      AbstractMatrix4.prototype.mulS = function mulS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) * value);
          }
      ...
      AbstractMatrix4.prototype.mulM = function mulM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.mul = function mul(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.mul(value);
      };
      AbstractMatrix4.prototype.multiply = AbstractMatrix4.prototype.mul;
      AbstractMatrix4.prototype.multiplyS = AbstractMatrix4.prototype.mulS;
      AbstractMatrix4.prototype.multiplyM = AbstractMatrix4.prototype.mulM;
      AbstractMatrix4.multiply = AbstractMatrix4.mul;
      AbstractMatrix4.prototype.div = function div(value) {
        if (typeof value === "number") return this.divS(value);
        return this.divM(value);
      };
      AbstractMatrix4.prototype.divS = function divS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) / value);
          }
      ...
      AbstractMatrix4.prototype.divM = function divM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.div = function div(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.div(value);
      };
      AbstractMatrix4.prototype.divide = AbstractMatrix4.prototype.div;
      AbstractMatrix4.prototype.divideS = AbstractMatrix4.prototype.divS;
      AbstractMatrix4.prototype.divideM = AbstractMatrix4.prototype.divM;
      AbstractMatrix4.divide = AbstractMatrix4.div;
      AbstractMatrix4.prototype.mod = function mod(value) {
        if (typeof value === "number") return this.modS(value);
        return this.modM(value);
      };
      AbstractMatrix4.prototype.modS = function modS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) % value);
          }
      ...
      AbstractMatrix4.prototype.modM = function modM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.mod = function mod(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.mod(value);
      };
      AbstractMatrix4.prototype.modulus = AbstractMatrix4.prototype.mod;
      AbstractMatrix4.prototype.modulusS = AbstractMatrix4.prototype.modS;
      AbstractMatrix4.prototype.modulusM = AbstractMatrix4.prototype.modM;
      AbstractMatrix4.modulus = AbstractMatrix4.mod;
      AbstractMatrix4.prototype.and = function and(value) {
        if (typeof value === "number") return this.andS(value);
        return this.andM(value);
      };
      AbstractMatrix4.prototype.andS = function andS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) & value);
          }
      ...
      AbstractMatrix4.prototype.andM = function andM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.and = function and(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.and(value);
      };
      AbstractMatrix4.prototype.or = function or(value) {
        if (typeof value === "number") return this.orS(value);
        return this.orM(value);
      };
      AbstractMatrix4.prototype.orS = function orS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) | value);
          }
      ...
      AbstractMatrix4.prototype.orM = function orM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.or = function or(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.or(value);
      };
      AbstractMatrix4.prototype.xor = function xor(value) {
        if (typeof value === "number") return this.xorS(value);
        return this.xorM(value);
      };
      AbstractMatrix4.prototype.xorS = function xorS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) ^ value);
          }
      ...
      AbstractMatrix4.prototype.xorM = function xorM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.xor = function xor(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.xor(value);
      };
      AbstractMatrix4.prototype.leftShift = function leftShift(value) {
        if (typeof value === "number") return this.leftShiftS(value);
        return this.leftShiftM(value);
      };
      AbstractMatrix4.prototype.leftShiftS = function leftShiftS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) << value);
          }
      ...
      AbstractMatrix4.prototype.leftShiftM = function leftShiftM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.leftShift = function leftShift(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.leftShift(value);
      };
      AbstractMatrix4.prototype.signPropagatingRightShift = function signPropagatingRightShift(value) {
        if (typeof value === "number") return this.signPropagatingRightShiftS(value);
        return this.signPropagatingRightShiftM(value);
      };
      AbstractMatrix4.prototype.signPropagatingRightShiftS = function signPropagatingRightShiftS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) >> value);
          }
      ...
      AbstractMatrix4.prototype.signPropagatingRightShiftM = function signPropagatingRightShiftM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.signPropagatingRightShift = function signPropagatingRightShift(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.signPropagatingRightShift(value);
      };
      AbstractMatrix4.prototype.rightShift = function rightShift(value) {
        if (typeof value === "number") return this.rightShiftS(value);
        return this.rightShiftM(value);
      };
      AbstractMatrix4.prototype.rightShiftS = function rightShiftS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) >>> value);
          }
      ...
      AbstractMatrix4.prototype.rightShiftM = function rightShiftM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
      ...
      AbstractMatrix4.rightShift = function rightShift(matrix2, value) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.rightShift(value);
      };
      AbstractMatrix4.prototype.zeroFillRightShift = AbstractMatrix4.prototype.rightShift;
      AbstractMatrix4.prototype.zeroFillRightShiftS = AbstractMatrix4.prototype.rightShiftS;
      AbstractMatrix4.prototype.zeroFillRightShiftM = AbstractMatrix4.prototype.rightShiftM;
      AbstractMatrix4.zeroFillRightShift = AbstractMatrix4.rightShift;
      AbstractMatrix4.prototype.not = function not() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.not = function not(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.not();
      };
      AbstractMatrix4.prototype.abs = function abs() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.abs = function abs(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.abs();
      };
      AbstractMatrix4.prototype.acos = function acos() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.acos = function acos(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.acos();
      };
      AbstractMatrix4.prototype.acosh = function acosh() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.acosh = function acosh(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.acosh();
      };
      AbstractMatrix4.prototype.asin = function asin() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.asin = function asin(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.asin();
      };
      AbstractMatrix4.prototype.asinh = function asinh() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.asinh = function asinh(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.asinh();
      };
      AbstractMatrix4.prototype.atan = function atan() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.atan = function atan(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.atan();
      };
      AbstractMatrix4.prototype.atanh = function atanh() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.atanh = function atanh(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.atanh();
      };
      AbstractMatrix4.prototype.cbrt = function cbrt() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.cbrt = function cbrt(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.cbrt();
      };
      AbstractMatrix4.prototype.ceil = function ceil() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.ceil = function ceil(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.ceil();
      };
      AbstractMatrix4.prototype.clz32 = function clz32() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.clz32 = function clz32(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.clz32();
      };
      AbstractMatrix4.prototype.cos = function cos() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.cos = function cos(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.cos();
      };
      AbstractMatrix4.prototype.cosh = function cosh() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.cosh = function cosh(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.cosh();
      };
      AbstractMatrix4.prototype.exp = function exp() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.exp = function exp(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.exp();
      };
      AbstractMatrix4.prototype.expm1 = function expm1() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.expm1 = function expm1(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.expm1();
      };
      AbstractMatrix4.prototype.floor = function floor() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.floor = function floor(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.floor();
      };
      AbstractMatrix4.prototype.fround = function fround() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.fround = function fround(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.fround();
      };
      AbstractMatrix4.prototype.log = function log() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.log = function log(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.log();
      };
      AbstractMatrix4.prototype.log1p = function log1p() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.log1p = function log1p(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.log1p();
      };
      AbstractMatrix4.prototype.log10 = function log10() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.log10 = function log10(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.log10();
      };
      AbstractMatrix4.prototype.log2 = function log2() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.log2 = function log2(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.log2();
      };
      AbstractMatrix4.prototype.round = function round() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.round = function round(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.round();
      };
      AbstractMatrix4.prototype.sign = function sign() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.sign = function sign(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.sign();
      };
      AbstractMatrix4.prototype.sin = function sin() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.sin = function sin(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.sin();
      };
      AbstractMatrix4.prototype.sinh = function sinh() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.sinh = function sinh(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.sinh();
      };
      AbstractMatrix4.prototype.sqrt = function sqrt() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.sqrt = function sqrt(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.sqrt();
      };
      AbstractMatrix4.prototype.tan = function tan() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.tan = function tan(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.tan();
      };
      AbstractMatrix4.prototype.tanh = function tanh() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.tanh = function tanh(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.tanh();
      };
      AbstractMatrix4.prototype.trunc = function trunc() {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
      ...
      AbstractMatrix4.trunc = function trunc(matrix2) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.trunc();
      };
      AbstractMatrix4.pow = function pow(matrix2, arg0) {
        const newMatrix = new Matrix4(matrix2);
        return newMatrix.pow(arg0);
      };
      AbstractMatrix4.prototype.pow = function pow(value) {
        if (typeof value === "number") return this.powS(value);
        return this.powM(value);
      };
      AbstractMatrix4.prototype.powS = function powS(value) {
        for (let i = 0; i < this.rows; i++) {
          for (let j = 0; j < this.columns; j++) {
            this.set(i, j, this.get(i, j) ** value);
          }
      ...
      AbstractMatrix4.prototype.powM = function powM(matrix2) {
        matrix2 = Matrix4.checkMatrix(matrix2);
        if (this.rows !== matrix2.rows || this.columns !== matrix2.columns) {
          throw new RangeError("Matrices dimensions must be equal");
        }
    ...
    var AbstractMatrix3 = class _AbstractMatrix {
    ...
    AbstractMatrix3.prototype.klass = "Matrix";
    if (typeof Symbol !== "undefined") {
      AbstractMatrix3.prototype[Symbol.for("nodejs.util.inspect.custom")] = inspectMatrix;
    }
    ...
    AbstractMatrix3.random = AbstractMatrix3.rand;
    AbstractMatrix3.randomInt = AbstractMatrix3.randInt;
    AbstractMatrix3.diagonal = AbstractMatrix3.diag;
    AbstractMatrix3.prototype.diagonal = AbstractMatrix3.prototype.diag;
    AbstractMatrix3.identity = AbstractMatrix3.eye;
    AbstractMatrix3.prototype.negate = AbstractMatrix3.prototype.neg;
    AbstractMatrix3.prototype.tensorProduct = AbstractMatrix3.prototype.kroneckerProduct;
    var _Matrix_instances, initData_fn;
    var _Matrix = class _Matrix extends AbstractMatrix3 {
    ...
    var Matrix3 = _Matrix;
    installMathOperations(AbstractMatrix3, Matrix3);
    var _matrix;
    var _SymmetricMatrix = class _SymmetricMatrix extends AbstractMatrix3 {
      /**
    ...
    _matrix = new WeakMap();
    var SymmetricMatrix3 = _SymmetricMatrix;
    SymmetricMatrix3.prototype.klassType = "SymmetricMatrix";
    var DistanceMatrix3 = class _DistanceMatrix extends SymmetricMatrix3 {
      /**
       * not the same as matrix.isSymmetric()
       * Here is to check if it's instanceof SymmetricMatrix without bundling issues
       *
      ...
      static isDistanceMatrix(value) {
        return SymmetricMatrix3.isSymmetricMatrix(value) && value.klassSubType === "DistanceMatrix";
      }
      ...
      toSymmetricMatrix() {
        return new SymmetricMatrix3(this);
      }
      clone() {
    ...
    DistanceMatrix3.prototype.klassSubType = "DistanceMatrix";
    var BaseView = class extends AbstractMatrix3 {
    ...
    var MatrixColumnView3 = class extends BaseView {
    ...
    var MatrixFlipColumnView3 = class extends BaseView {
      constructor(matrix2) {
    ...
    var MatrixFlipRowView3 = class extends BaseView {
      constructor(matrix2) {
        super(matrix2, matrix2.rows, matrix2.columns);
      }
      set(rowIndex, columnIndex, value) {
    ...
    var MatrixRowView3 = class extends BaseView {
    ...
    var MatrixRowSelectionView3 = class extends BaseView {
    ...
    var MatrixSelectionView3 = class extends BaseView {
    ...
    var MatrixSubView3 = class extends BaseView {
    ...
    var WrapperMatrix1D3 = class extends AbstractMatrix3 {
    ...
    var WrapperMatrix2D3 = class extends AbstractMatrix3 {
      constructor(data) {
        super();
        this.data = data;
    ...
    function wrap3(array, options) {
      if (isAnyArray2.isAnyArray(array)) {
        if (array[0] && isAnyArray2.isAnyArray(array[0])) {
          ...
          return new WrapperMatrix1D3(array, options);
        }
      } else {
        throw new Error("the argument is not an array");
      }
    }
    var LuDecomposition3 = class {
      constructor(matrix2) {
    ...
    function solve3(leftHandSide, rightHandSide, useSVD = false) {
      ...
      if (useSVD) {
        ...
        return leftHandSide.isSquare() ? new LuDecomposition3(leftHandSide).solve(rightHandSide) : new QrDecomposition3(leftHandSide).solve(rightHandSide);
      }
    }
    function determinant3(matrix2) {
      ...
      if (matrix2.isSquare()) {
        ...
        if (matrix2.columns === 2) {
          ...
          subMatrix0 = new MatrixSelectionView3(matrix2, [1, 2], [1, 2]);
          subMatrix1 = new MatrixSelectionView3(matrix2, [1, 2], [0, 2]);
          subMatrix2 = new MatrixSelectionView3(matrix2, [1, 2], [0, 1]);
          a = matrix2.get(0, 0);
          b = matrix2.get(0, 1);
          c = matrix2.get(0, 2);
          return a * determinant3(subMatrix0) - b * determinant3(subMatrix1) + c * determinant3(subMatrix2);
        } else {
          return new LuDecomposition3(matrix2).determinant;
        }
      } else {
    ...
    function linearDependencies3(matrix2, options = {}) {
    ...
    function correlation3(xMatrix, yMatrix = xMatrix, options = {}) {
      xMatrix = new Matrix3(xMatrix);
      let yIsSame = false;
      if (typeof yMatrix === "object" && !Matrix3.isMatrix(yMatrix) && !isAnyArray2.isAnyArray(yMatrix)) {
        options = yMatrix;
    ...
    var CholeskyDecomposition3 = class {
      constructor(value) {
        value = WrapperMatrix2D3.checkMatrix(value);
    ...
    exports.AbstractMatrix = AbstractMatrix3;
    exports.CHO = CholeskyDecomposition3;
    exports.CholeskyDecomposition = CholeskyDecomposition3;
    exports.DistanceMatrix = DistanceMatrix3;
    exports.EVD = EigenvalueDecomposition3;
    exports.EigenvalueDecomposition = EigenvalueDecomposition3;
    exports.LU = LuDecomposition3;
    exports.LuDecomposition = LuDecomposition3;
    exports.Matrix = Matrix3;
    exports.MatrixColumnSelectionView = MatrixColumnSelectionView3;
    exports.MatrixColumnView = MatrixColumnView3;
    exports.MatrixFlipColumnView = MatrixFlipColumnView3;
    exports.MatrixFlipRowView = MatrixFlipRowView3;
    exports.MatrixRowSelectionView = MatrixRowSelectionView3;
    exports.MatrixRowView = MatrixRowView3;
    exports.MatrixSelectionView = MatrixSelectionView3;
    exports.MatrixSubView = MatrixSubView3;
    ...
    exports.SymmetricMatrix = SymmetricMatrix3;
    exports.WrapperMatrix1D = WrapperMatrix1D3;
    exports.WrapperMatrix2D = WrapperMatrix2D3;
    exports.correlation = correlation3;
    exports.covariance = covariance3;
    exports.default = Matrix3;
    exports.determinant = determinant3;
    exports.inverse = inverse3;
    exports.linearDependencies = linearDependencies3;
...
var AbstractMatrix2 = matrix.AbstractMatrix;
var CHO2 = matrix.CHO;
var CholeskyDecomposition2 = matrix.CholeskyDecomposition;
var DistanceMatrix2 = matrix.DistanceMatrix;
var EVD2 = matrix.EVD;
var EigenvalueDecomposition2 = matrix.EigenvalueDecomposition;
var LU2 = matrix.LU;
var LuDecomposition2 = matrix.LuDecomposition;
var Matrix2 = matrix.Matrix;
var MatrixColumnSelectionView2 = matrix.MatrixColumnSelectionView;
var MatrixColumnView2 = matrix.MatrixColumnView;
var MatrixFlipColumnView2 = matrix.MatrixFlipColumnView;
var MatrixFlipRowView2 = matrix.MatrixFlipRowView;
var MatrixRowSelectionView2 = matrix.MatrixRowSelectionView;
var MatrixRowView2 = matrix.MatrixRowView;
var MatrixSelectionView2 = matrix.MatrixSelectionView;
var MatrixSubView2 = matrix.MatrixSubView;
var MatrixTransposeView2 = matrix.MatrixTransposeView;
var NIPALS2 = matrix.NIPALS;
var Nipals2 = matrix.Nipals;
var QR2 = matrix.QR;
var QrDecomposition2 = matrix.QrDecomposition;
var SVD2 = matrix.SVD;
var SingularValueDecomposition2 = matrix.SingularValueDecomposition;
var SymmetricMatrix2 = matrix.SymmetricMatrix;
var WrapperMatrix1D2 = matrix.WrapperMatrix1D;
var WrapperMatrix2D2 = matrix.WrapperMatrix2D;
var correlation2 = matrix.correlation;
var covariance2 = matrix.covariance;
var matrix_default = matrix.default.Matrix ? matrix.default.Matrix : matrix.Matrix;
var determinant2 = matrix.determinant;
var inverse2 = matrix.inverse;
var linearDependencies2 = matrix.linearDependencies;
var pseudoInverse2 = matrix.pseudoInverse;
var solve2 = matrix.solve;
var wrap2 = matrix.wrap;

export {
  AbstractMatrix2 as AbstractMatrix,
  CHO2 as CHO,
  CholeskyDecomposition2 as CholeskyDecomposition,
  DistanceMatrix2 as DistanceMatrix,
  EVD2 as EVD,
  EigenvalueDecomposition2 as EigenvalueDecomposition,
  LU2 as LU,
  LuDecomposition2 as LuDecomposition,
  Matrix2 as Matrix,
  MatrixColumnSelectionView2 as MatrixColumnSelectionView,
  MatrixColumnView2 as MatrixColumnView,
  MatrixFlipColumnView2 as MatrixFlipColumnView,
  MatrixFlipRowView2 as MatrixFlipRowView,
  MatrixRowSelectionView2 as MatrixRowSelectionView,
  MatrixRowView2 as MatrixRowView,
  MatrixSelectionView2 as MatrixSelectionView,
  MatrixSubView2 as MatrixSubView,
  MatrixTransposeView2 as MatrixTransposeView,
  NIPALS2 as NIPALS,
  Nipals2 as Nipals,
  QR2 as QR,
  QrDecomposition2 as QrDecomposition,
  SVD2 as SVD,
  SingularValueDecomposition2 as SingularValueDecomposition,
  SymmetricMatrix2 as SymmetricMatrix,
  WrapperMatrix1D2 as WrapperMatrix1D,
  WrapperMatrix2D2 as WrapperMatrix2D,
  correlation2 as correlation,
  covariance2 as covariance,
  matrix_default,
  determinant2 as determinant,
  inverse2 as inverse,
  linearDependencies2 as linearDependencies,
  pseudoInverse2 as pseudoInverse,
  solve2 as solve,
  wrap2 as wrap
};
//# sourceMappingURL=chunk-MCYIOEMD.js.map
